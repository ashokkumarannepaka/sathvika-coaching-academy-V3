...
export function QuickRegistration() {
  ...
  return (
    <section
      id="registration"
      className="py-16 bg-gradient-to-br from-blue-600 to-blue-800"
    >
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-blue-100">
              Register now and get free counseling from our expert team
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
            <motion.a
              href="https://wa.me/919035955777?text=Hi%20I%20want%20to%20join%20Sathvika%20Coaching%20Academy"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
